...
function program3(depth0,data) {
  ...
  hashTypes = {};
  hashContexts = {};
  stack1 = helpers['if'].call(depth0, "youtubeVideoUrl", {hash:{},inverse:self.noop,fn:self.program(3, program3, data),contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n        </div>\n      </div>\n</div><!-- /.modal -->\n\n");
  hashTypes = {};
  hashContexts = {};
  data.buffer.push(escapeExpression(helpers._triageMustache.call(depth0, "outlet", {hash:{},contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data})));
  data.buffer.push("\n<div class=\"footer\">\n  <div class=\"container\">\n    <div class=\"row\">\n      <div class=\"col-xs-12\">\n        <div class=\"pull-left\">\n          <img src=\"/images/logo.png\">\n          <div>\n            \"National Atlantic Bank\" is an OpenTok demo created by TokBox, a Telefónica Company.\n          </div>\n          <div>©2015 TokBox Inc.</div>\n        </div>\n        <div class=\"pull-right footer-links\">\n          <ul>\n            <li><a href=\"mailto:bizdev@tokbox.com\">Contact TokBox</a></li>\n          </ul>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n");
  return buffer;
...
Ember.TEMPLATES["components/chat-message"] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  var buffer = '', hashTypes, hashContexts, escapeExpression=this.escapeExpression;
...
function program3(depth0,data) {
  ...
  hashTypes = {};
  hashContexts = {};
  stack1 = helpers['if'].call(depth0, "rep", {hash:{},inverse:self.noop,fn:self.program(1, program1, data),contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n        ");
  hashTypes = {};
  hashContexts = {};
  stack1 = helpers['if'].call(depth0, "logout", {hash:{},inverse:self.noop,fn:self.program(3, program3, data),contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n      </ul>\n    </div>\n  </div>\n</nav>\n");
  return buffer;
